...
<div id="pop_content_page">
	<form id="disciplineCountFormId" action="${pageContext.request.contextPath}/instructor/discipline/disciplineExcel" method="post">
...
<script>
	...
	$("#studentQueryButton").click(function(){
	 	parent.layer.open({
	        ...
	        moveOut: true,
	        scrollbar: false,
	        content: '${pageContext.request.contextPath}/instructor/discipline/studentDiscipline',
	        end: function(){
