...
<div id="pop_content_page">
	<form id="linkNoteCountFormId" action="${pageContext.request.contextPath}/instructor/linkNote/linkNoteExcel" method="post">
	...
	$("#linkNoteCountButton").click(function() {
		...
		form.ajaxSubmit(function(data) {
			if(data=='error'){
				...
				window.location="${pageContext.request.contextPath}/instructor/linkNote/"+data+"/downloadlinkNote";
			};
		});
	});
