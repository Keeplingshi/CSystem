...
public class IJobInfoController {
	...
	public String getjobInfoList(@ModelAttribute("pageInfo") PageInfo pageInfo
		...
		if(userDomain!=null){
			if(userDomain.getCollege()!=null&&userDomain.getGrade()!=null){
				...
				List<JobInfoDomain> jobInfoList=jobInfoService.doSearchjobInfoPageList(pageInfo, gradeId,collegeId, null, null,null,null, null,null,null, null);
	...
	public String dojobInfoSearchList(@ModelAttribute("pageInfo") PageInfo pageInfo
			...
			,String protocalStateId,String isPositive,String classId,String searchText,String sortMode,String sortValue)throws Exception{
		...
		if(userDomain!=null){
			if(userDomain.getCollege()!=null&&userDomain.getGrade()!=null){
				...
				List<JobInfoDomain> jobInfoList=jobInfoService.doSearchjobInfoPageList(pageInfo, gradeId, collegeId, majorId
						, classId,contractStatusId,protocalStateId, isPositive,searchText, sortMode, sortValue);
