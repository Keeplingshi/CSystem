...
public class PStudentController {
	...
	public String getstudentList(@ModelAttribute("pageInfo") PageInfo pageInfo,BindingResult bindingResult
		...
		if(userDomain!=null){
			...
			List<SelectItem> majorList=null;
			List<SelectItem> classList=null;
			List<StudentDomain> studentList=null;
	...
	public String dostudentView(Model model,@PathVariable String id) throws Exception{
		...
		return "/portalView/student/studentView";
	}
	...
	public String dostudentEdit(Model model,@PathVariable String id)throws Exception{
		...
		return "/portalView/student/studentEdit";
	}
	...
	public String dostudentChooseView(@ModelAttribute("pagedialogInfo") PageInfo pagedialogInfo,Model model,
		...
		return "/portalView/student/studentChooseView";
	}
	...
	public String dostudentExcelView(Model model)throws Exception{
		...
		return "/portalView/student/studentExcelView";
	}
	...
	public String dostudentDBToExcelView(Model model)throws Exception{
		...
		return "/portalView/student/studentDBToExcelView";
	}
	 ...
	 * @return
	 * @throws Exception
	 * @author:portalistrator 2016-2-17
