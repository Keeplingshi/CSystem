...
<form id="formId" action="${pageContext.request.contextPath}/admin/family/familySearchList" method="post">
...
<script type="text/javascript">
	...
	$("#familyExcelToDBButton").click(function(){
		parent.layer.open({
	        ...
	        area : ['600px' , '500px'],
	        offset: ['100px'],
	        content: '${pageContext.request.contextPath}/admin/family/familyExcelToDBView',
	        end: function(){
	...
	$("#familyAddButton").click(function(){
	    parent.layer.open({
	        ...
	        area : ['380px' , '300px'],
	        offset: ['150px'],
	        content: '${pageContext.request.contextPath}/admin/family/familyAdd',
	        end: function(){
				//默认加载家庭成员列表
	    		$("#formId").ajaxSubmit(function(data){
	        	 	$("#content_page").html(data);
	...
	function viewfamily(familyId)
	{
	    parent.layer.open({
	        ...
	        area : ['380px' , '360px'],
	        offset: ['150px'],
	        content: '${pageContext.request.contextPath}/admin/family/familyView/'+familyId
	    });
	}
	...
	function updatefamily(familyId)
	{
	    parent.layer.open({
	        ...
	        area : ['380px' , '300px'],
	        offset: ['150px'],
	        content: '${pageContext.request.contextPath}/admin/family/familyEdit/'+familyId,
	        end: function(){
	        	//默认加载用户列表
	        	$("#formId").ajaxSubmit(function(data){
	        	 	$("#content_page").html(data);
	...
	function deletefamily(familyId)
	{
		...
		layer.confirm('是否确定删除？', {
		    btn: ['确定','取消'] //按钮
	 		...
	 		//默认加载家庭成员列表
			$.post("${pageContext.request.contextPath}/admin/family/delete/"+familyId, function(result){
				if(result=='success'){
					//默认加载家庭成员列表
		        	$("#formId").ajaxSubmit(function(data){
		        	 	$("#content_page").html(data);
	...
	$("#familyDeleteButton").click(function(){
		...
		layer.confirm('是否确定删除这些家庭成员？', {
			...
			console.info("确定");
			$.ajax({
				url : "${pageContext.request.contextPath}/admin/family/deleteFamilies",
				async: false,
				data : {
					"familyIds" : familyIds
				},
