...
<form id="linkNoteAddFormId" modelAttribute="domain" action="${pageContext.request.contextPath}/admin/linkNote/save" method="post">
	...
	<table>
		...
		<tr>
			...
			<td class="lestb">
				<input type="text" name="time" class="Wdate" readonly="readonly" placeholder="日期" onfocus="WdatePicker({maxDate:'%y-%M-%d'})" 
					value="<fmt:formatDate value="<%=new Date() %>" pattern="yyyy-MM-dd"/>" style="width: 150px;height: 30px;cursor: pointer;"/> 
			</td>
		</tr>
		<tr>
