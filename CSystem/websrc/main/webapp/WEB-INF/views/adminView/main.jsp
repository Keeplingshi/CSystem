...
<html>
	<head>
		...
		<script type="text/javascript">
			$(function(){
				//默认加载用户列表
				$.post("${pageContext.request.contextPath}/admin/user/userList", function(result){
...
<!-- 						<li id="linkNote_manage">
	...
	<script>
		...
		$("#college_manage").click(function(){
			...
			$.post("${pageContext.request.contextPath}/admin/college/collegeList", function(result){
				$("#content_page").empty();
				$("#content_page").html(result);
			});
		});
		...
		$("#major_manage").click(function(){
			...
			$.post("${pageContext.request.contextPath}/admin/major/majorList", function(result){
				$("#content_page").empty();
				$("#content_page").html(result);
			});
		});
		...
		$("#class_manage").click(function(){
			...
			$.post("${pageContext.request.contextPath}/admin/class/classList", function(result){
				$("#content_page").empty();
				$("#content_page").html(result);
			});
		});
		...
		$("#student_manage").click(function(){
			...
			$.post("${pageContext.request.contextPath}/admin/student/studentList", function(result){
				$("#content_page").empty();
				$("#content_page").html(result);
			});
		});
		...
		$("#job_manage").click(function(){
			$.post("${pageContext.request.contextPath}/admin/jobInfo/jobInfoList", function(result){
				$("#content_page").empty();
				$("#content_page").html(result);
			});
		});
		...
		$("#family_manage").click(function(){
			$.post("${pageContext.request.contextPath}/admin/family/familyList", function(result){
				$("#content_page").empty();
				$("#content_page").html(result);
			});
		});
