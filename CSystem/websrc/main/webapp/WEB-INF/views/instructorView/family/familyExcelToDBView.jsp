...
<script src="${pageContext.request.contextPath}/resources/plugins/webuploader/csystem/familyexcelupload.js"></script>

<table>
	<tr style="height: 60px;">
		<td>
		<a href="${pageContext.request.contextPath}/instructor/family/downloadfamilyExcel"><input type="button" id="excelDownload" class="button button-primary button-rounded button-small" value="模板下载"/></a>  
		</td>
	</tr>
  	<tr style="height: 60px;">
		<td>
