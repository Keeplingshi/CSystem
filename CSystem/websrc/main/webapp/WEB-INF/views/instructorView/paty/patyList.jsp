...
<div>
<form id="formId" action="${pageContext.request.contextPath}/instructor/paty/patySearchList" method="post">
...
<script type="text/javascript">
	...
	$("#patyDBToExcelButton").click(function(){
		parent.layer.open({
	        ...
	        area : ['600px' , '350px'],
	        offset: ['100px'],
	        content: '${pageContext.request.contextPath}/instructor/paty/patyDBToExcelView',
	        end: function(){
 	...
 	$("#patyExcelToDBButton").click(function(){
		...
		parent.layer.open({
	        ...
	        area : ['600px' , '500px'],
	        offset: ['100px'],
	        content: '${pageContext.request.contextPath}/instructor/paty/patyExcelToDBView',
	        end: function(){
	...
	$("#testBtn").click(function(){
      	...
      	$.ajax({
			url:'${pageContext.request.contextPath}/instructor/paty/test',
			type:"post",
			error:function(e){
			},
	...
	function updatepaty(patyId)
	{
	    parent.layer.open({
	        ...
	        area : ['700px' , '600px'],
	        offset: ['100px'],
	        content: '${pageContext.request.contextPath}/instructor/paty/patyEdit/'+patyId,
	        end: function(){
	        	//默认加载用户列表
	        	$("#formId").ajaxSubmit(function(data){
	        	 	$("#content_page").html(data);
	...
	function viewpaty(patyId)
	{
	    parent.layer.open({
	        ...
	        area : ['700px' , '600px'],
	        offset: ['100px'],
	        content: '${pageContext.request.contextPath}/instructor/paty/patyView/'+patyId
	    });
	}
