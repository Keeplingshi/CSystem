...
<form id="formId" action="${pageContext.request.contextPath}/instructor/discipline/disciplineSearchList" method="post">
...
<script type="text/javascript">
	...
	$("#disciplineReportButton").click(function(){
		parent.layer.open({
	        ...
	        area : ['600px' , '400px'],
	        offset: ['100px'],
	        content: '${pageContext.request.contextPath}/instructor/discipline/disciplineCountView'
	    });
	});
	...
	$("#disciplineAddButton").click(function(){
	    parent.layer.open({
	        ...
	        area : ['800px' , '650px'],
	        offset: '130px',
	        content: '${pageContext.request.contextPath}/instructor/discipline/disciplineAdd',
	        end: function(){
				//默认加载违纪类型列表
	    		$("#formId").ajaxSubmit(function(data){
	        	 	$("#content_page").html(data);
	...
	function viewdiscipline(disciplineId)
	{
	    parent.layer.open({
	        ...
	        area : ['600px' , '470px'],
	        offset: ['100px'],
	        content: '${pageContext.request.contextPath}/instructor/discipline/disciplineView/'+disciplineId
	    });
	}
	...
	function updatediscipline(disciplineId)
	{
	    parent.layer.open({
	        ...
	        area : ['600px' , '470px'],
	        offset: ['100px'],
	        content: '${pageContext.request.contextPath}/instructor/discipline/disciplineEdit/'+disciplineId,
	        end: function(){
	        	//默认加载用户列表
	        	$("#formId").ajaxSubmit(function(data){
	        	 	$("#content_page").html(data);
	...
	function deletediscipline(disciplineId)
	{
		...
		layer.confirm('是否确定删除？', {
		    ...
		    btn: ['确定','取消'] //按钮
	 		...
	 		//默认加载违纪类型列表
			$.post("${pageContext.request.contextPath}/instructor/discipline/delete/"+disciplineId, function(result){
				if(result=='success'){
					//默认加载违纪类型列表
		        	$("#formId").ajaxSubmit(function(data){
		        	 	$("#content_page").html(data);
	...
	$("#disciplineDeleteButton").click(function(){
		...
		layer.confirm('是否确定删除这些记录？', {
			...
			$.ajax({
				url : "${pageContext.request.contextPath}/instructor/discipline/deleteDisciplines",
				async: false,
				data : {
