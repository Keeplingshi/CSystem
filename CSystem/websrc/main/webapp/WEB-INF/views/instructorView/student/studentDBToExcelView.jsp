...
<form id="studentDBtoExcelFormId" modelAttribute="domain" action="${pageContext.request.contextPath}/instructor/student/studentDBToExcel" method="post">
...
/* 			if(result=='success'){
				...
				window.location="${pageContext.request.contextPath}/instructor/student/downloadStudentInfo";
