...
<body>
 ...
 <div class="head">	
        ...
        <div id="container">
          <div class="demo">
                <form id="myform2" action="AddQrecord.do" method="get">
                     ...
                     <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="name" id="name" class="input required" />
                               <font size="2px" color="#C0C0C0">请输入询问人姓名</font>
                            </td>
                        </tr>
                       <tr>
                            <td align="right">询问时间：</td>
                            <td>
                            <input type="text" name="askTime" id="askTime" class="input required" />
                          ...
                          <tr>
                            ...
                            <td> <input type="text" name="askedName" id="askedName" class="input required" />
                               <font size="2px" color="#C0C0C0">请填写被询问人的姓名</font>
                             </td>
                        </tr>
                               <tr>
                            <td align="right">询问记录：</td>
                            <td><textarea style="height: 150px;width: 490px;" name="content" id="content" class="input required" onkeydown="checkMaxInput(this,1000)"  
            onkeyup="checkMaxInput(this,1000)" onfocus="checkMaxInput(this,1000)" onblur="checkMaxInput(this,1000);resetMaxmsg()"></textarea>
                               <br /> <font size="2px" color="#C0C0C0" >请填写询问记录</font>
                             </td>
                        </tr>
                        <tr>
                            <td height="42">&nbsp;</td>
