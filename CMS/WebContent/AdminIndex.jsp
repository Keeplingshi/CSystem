...
<script type="text/javascript">
	...
	window.onload=function(){
		...
		document.getElementById("topFrame").src="AdminTop.jsp?ip="+ip+"&localIP="+localIP+"&staffDomain="+staffDomain;
...
<frameset rows="88,*" cols="*" frameborder="no" border="0" framespacing="0">
  ...
  <frameset cols="187,*" frameborder="no" border="0" framespacing="0">
    ...
    <frame src="AdminImgtable.jsp" name="rightFrame" id="rightFrame" title="rightFrame" />
  </frameset>
</frameset>
<noframes>
<body>
