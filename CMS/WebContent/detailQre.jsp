...
window.close();
     ...
     <div id="forms" class="mt10">
        <div class="box">
          <div class="box_border">
            <div class="box_top"><b class="pl15">询问表详情查看</b></div>
              <form action="" class="jqtransform">
               <table class="form_table pt15 pb15" width="50%"  style="margin:0 auto" id="detailQTable">
                 ...
                 <td class="td_right" width="40%">案件编号：</td>
                  <td id="id" width="60%">${caseRegisterId}</td>
                </tr>
                <tr >
                  <td class="td_right">询问人姓名：</td>
                  <td id="name">${handleStaff}</td>
                 </tr>
               <%--   <tr>
                  <td class="td_right"width="20%">身份证号：</td>
                  <td id="idcard" width="10%">${caseRegisterId}</td>
                 </tr> --%>
                 <tr>
                 ...
                 <tr> 
                   <td class="td_right">询问时间：</td>
                  <td id="askTime">${askTime}</td>
                 </tr>
                 <tr>
                    <td class="td_right">被询问人姓名：</td>
                  <td id="askedName">${askedPerson}</td>
                </tr>
                <tr>  
 ...
 <!--    <script type="text/javascript">
   ...
   var askTime = GetQueryString("askTime");
   document.getElementById("askTime").innerText = askTime ;

   var askedName = GetQueryString("askedName");
   document.getElementById("askedName").innerText = askedName ;
