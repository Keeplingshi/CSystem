     ...
     <div id="forms" class="mt10">
        <div class="box">
          <div class="box_border">
            <div class="box_top"><b class="pl15">逮捕表详情查看</b></div>
              <form action="" class="jqtransform">
               <table class="form_table pt15 pb15" width="50%"  style="margin:0 auto" id="detailQTable">
                 <tr>
                 <td class="td_right" width="40%">逮捕表编号：</td>
                  <td id="id" width="60%">${id}</td>
                </tr>
                <tr>
                 <td class="td_right" width="40%">案件编号：</td>
                  <td id="idcard" width="60%">${caseRegisterId}</td>
                </tr>
                <tr >
                  <td class="td_right">逮捕人姓名：</td>
                  <td id="name">${chargeName}</td>
                 </tr>
                 <tr>
                   <td class="td_right">逮捕原因：</td>
                  <td id="content">${reason}</td>
                 </tr>
                 <tr> 
                   <td class="td_right">申请逮捕时间：</td>
                  <td id="askTime">${time}</td>
                 </tr>
                 <tr>
                    <td class="td_right">处理人姓名：</td>
                  <td id="handleName">${handleName}</td>
                </tr>
                <tr>  
