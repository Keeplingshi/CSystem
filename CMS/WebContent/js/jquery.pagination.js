 ...
 (function($){
	...
	$.fn.pagination = function(maxentries, opts){
		...
		function InitTable(pageIndex) { 
			...
			now.innerText = pageIndex+1;
			$.ajax({ 
				type: "POST", 
				dataType: "text", 
				url:"paging.do?flag=police", //提交到一般处理程序请求数据 
...
var birthPalcetd = document.createElement("td");
   	...
   	var victim_nametd = document.createElement("td");
		...
		statetd.appendChild(stateText);
			    		...
			    		/*trElement.appendChild(nationtd);
			    		trElement.appendChild(sextd);
			    		trElement.appendChild(politics_statustd);
			    		trElement.appendChild(is_CriminalRecordtd);
			    		trElement.appendChild(chargetd);
			    		trElement.appendChild(charge_maintd);
			    		trElement.appendChild(charge_nexttd);
			    		trElement.appendChild(victim_nametd);
			    		trElement.appendChild(Sue_nametd);
			    		trElement.appendChild(native_palacetd);
			    		trElement.appendChild(Sue_phonetd);
			    		trElement.appendChild(charge_familyNametd);
			    		trElement.appendChild(charge_familyPhonetd);*/
