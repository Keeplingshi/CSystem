 ...
 */
 (function($){
	...
	// Extend jQuery
	$.fn.paginationadmin6 = function(maxentries, opts){
		...
		function InitTable(pageIndex) { 
			...
			$.ajax({ 
				type: "POST", 
				dataType: "text", 
				url:"pagingArrest.do?flag=admin", //提交到一般处理程序请求数据 
				contentType: "application/x-www-form-urlencoded; charset=utf-8",
				data:"pageIndex=" + (pageIndex)+ "&pageSize=" + 8,/*"pageIndex=" + (pageIndex) + "&pageSize=" + pageSize*/ //提交两个参数：pageIndex(页面索引)，pageSize(显示条数) 
