         ...
         <div class="box_bottom pb5 pt5 pr10" style="border-top:1px solid #dadada;">
          ...
          <div class="demo">
            <div class="box_top"><b class="pl15" style="text-align:center;">搜查表修改</b></div>
                <form id="myform" action="geteditArrest.do" method="get">
                ...
                <tr >
                  ...
                  <tr>
                 <td class="td_right">嫌疑人姓名：</td>
                  <td ><input type="text" name="name" class="input-text lh30 input required" value="${chargeName }"/></td>
                 </tr>
                  <tr>
                 <td class="td_right">逮捕时间：</td>
                 ...
                 <td class="td_right">处理人姓名：</td>
                  <td ><input type="text" name="handleName" class="input-text lh30 input required" value="${handleName}"/></td>
                   ...
                   <tr >
                  <td width="22%" align="right">逮捕原因：</td>
                  <td><textarea style="height: 150px;width: 490px;" name="reason" id="reason" class="input-text lh30 input required">${reason}</textarea>
                   	<p>请输入逮捕内容</p>
                  </td>
                 </tr>
                 <tr>
