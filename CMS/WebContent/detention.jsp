...
<body>
 ...
 <div class="head">	
        ...
        <div id="container">
          <div class="demo">
                <form id="myform4" action="AddDetention.do" method="get">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="mytable">
                     <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="askedName" id="askedName" class="input required" />
                                <font size="2px" color="#C0C0C0">输入询问人姓名</font>
                            </td>
                        </tr>
                       
                          <tr>
                            <td align="right">处理人姓名：</td>
                            <td> <input type="text" name="handleName" id="handleName" class="input required" />
                               <font size="2px" color="#C0C0C0">请填写处理人姓名</font>
                             </td>
                        </tr>
                		<tr>
                            <td align="right">原因：</td>
                            <td>
                            <textarea style="height: 150px;width: 490px;" type="text" name="reason" id="reason" class="input required"  onkeydown="checkMaxInput(this,1000)"  
            onkeyup="checkMaxInput(this,1000)" onfocus="checkMaxInput(this,1000)" onblur="checkMaxInput(this,1000);resetMaxmsg()"></textarea>
                               <br /><font size="2px" color="#C0C0C0" >请输入想要拘留嫌疑人原因</font>
                             </td>
                        </tr>		
                         <tr>
                            <td align="right">拘留时间：</td>
                            <td><input name="time" id="time" class="input required"/>
                                <font size="2px" color="#C0C0C0">形式如1999-01-01</font>
                             </td>
                        </tr>
                        <tr>
                            <td height="42">&nbsp;</td>
