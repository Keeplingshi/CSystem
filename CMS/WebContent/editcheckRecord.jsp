 ...
 <div class="head">	
        ...
        <div class="box_bottom pb5 pt5 pr10" style="border-top:1px solid #dadada;">
            ...
            <div class="box_top"><b class="pl15" style="text-align:center;">搜查表修改</b></div>
                <form id="myform" action="geteditCheckR.do" method="get">
                ...
                <tr >
                  <td width="22%" align="right">案件登记表表id：</td>
                   ...
                   <tr >
                  <td width="22%" align="right">搜查内容：</td>
                 ...
                 <td class="td_right">审核结果：</td>
                  <td ><input type="text" name="resultState" class="input-text lh30 input required" value="${result_state}"/></td>
                 </tr>
