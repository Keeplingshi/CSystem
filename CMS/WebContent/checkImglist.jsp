...
<script type="text/javascript" src="js/jquery.paginationCQ2.js"></script>
<script type="text/javascript" src="js/checkImglist.js"></script>
<!-- <script type="text/javascript">
$(document).ready(function() {
	$("#Pagination2").pagination4("15");  
});
</script> -->
...
<body>
	...
	<div class="place">
	    <span>位置：</span>
	    <ul class="placeul">
		    <li><a href="checkImglist.jsp">搜查笔录记录档案</a></li>
	    </ul>
    </div>
    <div class="rightinfo">
	    	...
	    	<ul class="toolbar" style="float:left;">
	         ...
	         <div class="search-box" style=" padding-top:20px;position: relative; z-index: 5;float:right;">
                        ...
                        <select id="querySelectQ">
                        	...
                        	<input type="button" id=queryCRid onclick="queryC()"value="搜索"/>
                        </div>
             </div>
	    </div>
	    
   	 	<div class="formtitle"><span>搜查笔录记录</span></div>  
   		<div class="toolsli">
