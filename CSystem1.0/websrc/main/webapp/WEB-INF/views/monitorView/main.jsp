...
<html>
	<head>
		...
		<script type="text/javascript">
			$(function(){
				//默认加载用户列表
				$.post("${pageContext.request.contextPath}/monitor/student/studentList", function(result){
	...
	<script>
		...
		$("#job_manage").click(function(){
			$.post("${pageContext.request.contextPath}/monitor/jobInfo/jobInfoList", function(result){
				$("#content_page").empty();
				$("#content_page").html(result);
			});
		});
