...
<table>
	<tr style="height: 60px;">
		<td>
		<a href="${pageContext.request.contextPath}/admin/paty/downloadPatyExcel"><input type="button" id="excelDownload" class="button button-primary button-rounded button-small" value="模板下载"/></a>  
		</td>
	</tr>
  	<tr style="height: 60px;">
		<td>
