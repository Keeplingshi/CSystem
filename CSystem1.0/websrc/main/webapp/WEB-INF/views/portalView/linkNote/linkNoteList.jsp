...
<form id="formId" action="${pageContext.request.contextPath}/admin/linkNote/linkNoteSearchList" method="post">
...
<script type="text/javascript">
	...
	$("#linkNoteReportButton").click(function(){
		parent.layer.open({
	        ...
	        area : ['600px' , '400px'],
	        offset: ['100px'],
	        content: '${pageContext.request.contextPath}/admin/linkNote/linkNoteCountView'
	    });
	});
	...
	$("#linkNoteAddButton").click(function(){
	    parent.layer.open({
	        ...
	        area : ['800px' , '650px'],
	        offset: '130px',
	        content: '${pageContext.request.contextPath}/admin/linkNote/linkNoteAdd',
	        end: function(){
				//默认加载联系笔记类型列表
	    		$("#formId").ajaxSubmit(function(data){
	        	 	$("#content_page").html(data);
	...
	function viewlinkNote(linkNoteId)
	{
	    parent.layer.open({
	        ...
	        area : ['600px' , '470px'],
	        offset: ['100px'],
	        content: '${pageContext.request.contextPath}/admin/linkNote/linkNoteView/'+linkNoteId
	    });
	}
	...
	function updatelinkNote(linkNoteId)
	{
	    parent.layer.open({
	        ...
	        area : ['600px' , '470px'],
	        offset: ['100px'],
	        content: '${pageContext.request.contextPath}/admin/linkNote/linkNoteEdit/'+linkNoteId,
	        end: function(){
	        	//默认加载用户列表
	        	$("#formId").ajaxSubmit(function(data){
	        	 	$("#content_page").html(data);
	...
	function deletelinkNote(linkNoteId)
	{
		...
		layer.confirm('是否确定删除？', {
		    ...
		    btn: ['确定','取消'] //按钮
	 		...
	 		//默认加载联系笔记类型列表
			$.post("${pageContext.request.contextPath}/admin/linkNote/delete/"+linkNoteId, function(result){
				if(result=='success'){
					//默认加载联系笔记类型列表
		        	$("#formId").ajaxSubmit(function(data){
		        	 	$("#content_page").html(data);
	...
	$("#linkNoteDeleteButton").click(function(){
		...
		layer.confirm('是否确定删除这些记录？', {
			...
			$.ajax({
				url : "${pageContext.request.contextPath}/admin/linkNote/deletelinkNotes",
				async: false,
				data : {
