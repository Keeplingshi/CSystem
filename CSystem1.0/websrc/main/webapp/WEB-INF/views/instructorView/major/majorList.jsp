...
<form id="formId" action="${pageContext.request.contextPath}/instructor/major/majorSearchList" method="post">
...
<script type="text/javascript">
	...
	$("#majorAddButton").click(function(){
	    parent.layer.open({
	        ...
	        area : ['380px' , '280px'],
	        offset: ['150px'],
	        content: '${pageContext.request.contextPath}/instructor/major/majorAdd',
	        end: function(){
				//默认加载专业列表
	    		$("#formId").ajaxSubmit(function(data){
	        	 	$("#content_page").html(data);
	...
	function viewmajor(majorId)
	{
	    parent.layer.open({
	        ...
	        area : ['380px' , '280px'],
	        offset: ['150px'],
	        content: '${pageContext.request.contextPath}/instructor/major/majorView/'+majorId
	    });
	}
	...
	function updatemajor(majorId)
	{
	    parent.layer.open({
	        ...
	        area : ['380px' , '280px'],
	        offset: ['150px'],
	        content: '${pageContext.request.contextPath}/instructor/major/majorEdit/'+majorId,
	        end: function(){
	        	//默认加载用户列表
	        	$("#formId").ajaxSubmit(function(data){
	        	 	$("#content_page").html(data);
	...
	function deletemajor(majorId)
	{
		...
		layer.confirm('是否确定删除？', {
		    btn: ['确定','取消'] //按钮
	 		...
	 		//默认加载专业列表
			$.post("${pageContext.request.contextPath}/instructor/major/delete/"+majorId, function(result){
				if(result=='success'){
					//默认加载专业列表
		        	$("#formId").ajaxSubmit(function(data){
		        	 	$("#content_page").html(data);
