...
<div>
<form id="formId" action="${pageContext.request.contextPath}/instructor/student/studentSearchList" method="post">
...
<script type="text/javascript">
	...
	function deletestudent(studentId)
	{
		...
		layer.confirm('是否确定删除？', {
		    ...
		    btn: ['确定','取消'] //按钮
	 		...
	 		//默认加载学生列表
			$.post("${pageContext.request.contextPath}/instructor/student/delete/"+studentId, function(result){
				if(result=='success'){
					//默认加载学生列表
		        	$("#formId").ajaxSubmit(function(data){
		        	 	$("#content_page").html(data);
	...
	$("#studentDeleteButton").click(function(){
		...
		layer.confirm('是否确定删除这些学生？', {
			...
			$.ajax({
				url : "${pageContext.request.contextPath}/instructor/student/deleteStudents",
				async: false,
				data : {
	...
	$("#studentExcelToDBButton").click(function(){
	    parent.layer.open({
	        ...
	        area : ['700px' , '500px'],
	        offset: ['100px'],
	        content: '${pageContext.request.contextPath}/instructor/student/studentExcelView',
	        end: function(){
	        	//默认加载用户列表
	        	$("#formId").ajaxSubmit(function(data){
	        	 	$("#content_page").html(data);
	...
	$("#studentDBToExcelButton").click(function(){
	    parent.layer.open({
	        ...
	        area : ['700px' , '500px'],
	        offset: ['100px'],
	        content: '${pageContext.request.contextPath}/instructor/student/studentDBToExcelView'
	    });
	});
